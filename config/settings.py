...
OPENAI_QUESTION_MODEL = os.getenv(
    "OPENAI_QUESTION_MODEL", 
    "gpt-5.6-terra"
)
OPENAI_QUESTION_REASONING_EFFORT = os.getenv(
    "OPENAI_QUESTION_REASONING_EFFORT",
    "high",
)
OPENAI_EVALUATION_MODEL = os.getenv(
    "OPENAI_EVALUATION_MODEL",
    "gpt-5.6-terra",
)
OPENAI_EVALUATION_REASONING_EFFORT = os.getenv(
